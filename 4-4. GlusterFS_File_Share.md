...
<br/> DNS이름 및 FQDN에 의존하기 때문에 hosts 파일 편집이 필요.
<br/>rocky1 IP 주소는 192.168.0.68 hostnmae server1
<br/>rocky2 IP 주소는 192.168.0.69 hostnmae server2
...
#### gluster peer 등록
```
이 명령은 단일 노드(여기서는 rocky1서버)에서 한 번만 수행
